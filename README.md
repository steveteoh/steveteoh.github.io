...
1. Below is the latest statistical map that contains all state related variables. The dropdown options are auto generated. [Here's the link](https://steveteoh.github.io/Statistics/) (auto updated based on data from https://github.com/MoH-Malaysia/covid19-public/)  |  ![Statistic Maps](https://steveteoh.github.io/img/statistics.png)
